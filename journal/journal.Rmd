...
#xldf_clean |> filter(category=="sounds2") |> pull(uni_lemma) # just "oink"
...
prod_cat <- xldf_clean |>
  filter(!is.na(d), !is.na(semantic_category),
         !is.element(semantic_category, c("final_particles", "directions", "numbers", "articles", "other",
                                 "descriptive_words (adverbs)", "states", "unknown",
                                 "conversations", "sounds2", "prepositional_pronouns",
                                 "verb_endings", "verb_modifiers", "others",
