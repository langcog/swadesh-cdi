...
abstract: >
    ...
    as a starting point for future CDI adaptations. We test how well the proposed list generalizes to data 
    from 10 additional languages.
...
The lack of CDIs in these languages is a significant barrier to understanding the diversity of language development across the world, which is crucial for developing and validating theories of language acquisition that are purportedly universal [@kidd2022; @singh2023].
