...
#                       caption = "Swadesh CDI vs. Full CDI:WS scores for 32 training languages.")
#print(xx_tab, type="html", comment = F, table.placement = "H", include.rownames=FALSE)

xx %>% kable(digits=3, caption="Swadesh CDI vs. Full CDI:WS scores for 32 training languages.") %>%
