...
syntactic_sublist <- make_proportional_sublist(prod_syntactic_sum, S_LEN, 25, syntactic_props) # ToDo: update with cross-validated k
strat2_sublist <- make_binned_swadesh_sublist(prod_semantic_sum, S_LEN, 26, n_bins=2)
