...
intersect(category_sublist$uni_lemma, strat2_sublist$uni_lemma) # 65
intersect(category_sublist26$uni_lemma, strat2_sublist$uni_lemma) # 63
intersect(unstrat_sublist$uni_lemma, strat2_sublist$uni_lemma) # 96 - !
intersect(unstrat_sublist$uni_lemma, category_sublist$uni_lemma) # 64
intersect(unstrat_sublist$uni_lemma, category_sublist26$uni_lemma) # 62
...
Unstratified is significantly easier than all items
```{r}
t.test(swadesh_sublist$mean_d,
       prod_sum$mean_d)
```

TODO: add comparison of 2 strata and category list difficulties
